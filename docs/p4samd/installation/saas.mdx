...
| **AI provider API key** | AI-powered features (Professional plan and above) | Optional, needed only to use AI capabilities. An API key from your own account with one of the supported providers: OpenAI, Anthropic, Google Vertex AI, or Azure OpenAI. P4SaMD does not provide or resell model access. Configured by an organization Admin on the LLM Profiles settings page. See [AI Configuration](../handbook/ai_configuration.md) for the setup steps. |
