...
Use P4SaMD's Brownfield Import to analyze a software product built without formal IEC 62304 compliance: identify gaps, assess regulatory risk, and build a prioritized remediation roadmap.

## Example Project

We'll analyze **NeuroTrack**, a neurology clinic management system in production for 3 years. The company wants CE marking under EU MDR to enter European markets, but the software was built before medical device regulations were considered.
...
> Business expansion into the EU requires CE marking. Legal review determined that EEG data storage and clinical report generation qualify the software as a Class IIa medical device under EU MDR.
...
<Tip type="info">
Be honest about the current state: underestimating gaps delays your timeline. P4SaMD's analysis is confidential.
</Tip>
...
4. Unauthorized access to patient records (GDPR violation)
...
Known incidents represent realized hazards, which makes them valuable for risk analysis. Document them honestly to help prioritize remediation work.
</Tip>
...
P4SaMD analyzes your inputs and generates a gap analysis:
...
1. Write the SRS based on current functionality (GAP-001)
2. Conduct initial risk analysis focused on known incidents (GAP-002)
...
<Tip type="info">
This is a realistic timeline for Class IIa software. Compressing below 9 months typically forces documentation shortcuts that cause Notified Body delays.
</Tip>
