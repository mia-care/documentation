...
This page walks you through each step of the Brownfield Import wizard. To launch it, go to the **Brownfield Session page** and click **Import Project**.
...
| **Target Market Jurisdiction** | Geographic markets where the device will be placed |
...
<Tip>
  You can pause at any time by clicking <strong>Save as Draft<strong> in the wizard footer. Click Resume on the draft card to pick up exactly where you left off. To exit without saving, click Cancel and choose Exit without saving; if you have never saved the session as a draft, no data is stored.
</Tip>
